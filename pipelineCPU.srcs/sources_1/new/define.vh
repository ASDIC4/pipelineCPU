...
`define InDelaySlot     1'b1            // 处于延迟槽
`define NotInDelaySlot  1'b0            // 不处于延迟槽
...
`define EXE_MFHI        6'b010000       // mfhi指令的功能码
`define EXE_MTHI        6'b010001       // mthi指令的功能码
`define EXE_MFLO        6'b010010       // mflo指令的功能码
`define EXE_MTLO        6'b010011       // mtlo指令的功能码
...
`define EXE_REGIMM_INST 6'b000001       // 分支指令的指令码
...
`define InstMemNum      63              // ROM的实际大小为128KB
